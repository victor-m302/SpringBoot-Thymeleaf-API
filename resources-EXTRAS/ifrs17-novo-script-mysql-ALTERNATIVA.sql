CREATE DATABASE  IF NOT EXISTS `ifrs17_database` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ifrs17_database`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: ifrs17_database
-- ------------------------------------------------------
...
INSERT INTO `perfis` VALUES (1,'ADMIN'),(2,'MEDICO'),(3,'PACIENTE'),(4,'ANALISTA'),(5,'CONSULTA');
...
CREATE TABLE `analistas` (
  ...
  KEY `FK_ANALISTA_USUARIO_ID` (`id_usuario`),
  CONSTRAINT `FK_ANALISTA_USUARIO_ID` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`)
...
--
-- Table structure for table `parametrizacoes`
--

DROP TABLE IF EXISTS `parametrizacoes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `parametrizacoes` (
  ...
  `id_carga` bigint(20) DEFAULT NULL,
  `id_motor` bigint(20) DEFAULT NULL,
  `id_status` bigint(20) DEFAULT NULL,

  PRIMARY KEY (`id`),
  KEY `FK_ANALISTA_ID` (`id_analista`),
  KEY `FK_CARGA_ID` (`id_carga`),
  KEY `FK_MOTOR_ID` (`id_motor`),
  KEY `FK_STATUS_ID` (`id_status`),


  CONSTRAINT `FK_ANALISTA_ID` FOREIGN KEY (`id_analista`) REFERENCES `analistas` (`id`),
  CONSTRAINT `FK_CARGA_ID` FOREIGN KEY (`id_carga`) REFERENCES `cargas` (`id`),
  CONSTRAINT `FK_MOTOR_ID` FOREIGN KEY (`id_motor`) REFERENCES `motores` (`id`),
  CONSTRAINT `FK_STATUS_ID` FOREIGN KEY (`id_status`) REFERENCES `status_carga` (`id`)
...
--
-- Dumping data for table `parametrizacoes`
--

LOCK TABLES `parametrizacoes` WRITE;
/*!40000 ALTER TABLE `parametrizacoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `parametrizacoes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `motores_tem_cargas`
--

DROP TABLE IF EXISTS `motores_tem_cargas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `motores_tem_cargas` (
  `id_carga` bigint(20) NOT NULL,
  `id_motor` bigint(20) NOT NULL,

  UNIQUE KEY `MOTORES_UNIQUE_CARGAS` (`id_carga`,`id_motor`),

  KEY `FK_CARGA_MOTOR_ID` (`id_motor`),
  CONSTRAINT `FK_CARGA_MOTOR_ID` FOREIGN KEY (`id_motor`) REFERENCES `motores` (`id`),
  CONSTRAINT `FK_MOTOR_CARGA_ID` FOREIGN KEY (`id_carga`) REFERENCES `cargas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `motores_tem_cargas`
--

LOCK TABLES `motores_tem_cargas` WRITE;
/*!40000 ALTER TABLE `motores_tem_cargas` DISABLE KEYS */;
/*!40000 ALTER TABLE `motores_tem_cargas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `status_carga`
--
...
--
-- Dumping data for table `status_carga`
--

LOCK TABLES `status_carga` WRITE;
/*!40000 ALTER TABLE `status_carga` DISABLE KEYS */;
INSERT INTO `status_carga` VALUES (1,'CERTO'),(2,'PENDENTE'),(3,'ERRO');
/*!40000 ALTER TABLE `status_carga` ENABLE KEYS */;
UNLOCK TABLES;


--
-- Dumping routines for database 'ifrs17_database'
--
