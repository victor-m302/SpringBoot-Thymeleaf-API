...
--
-- Table structure for table `analista_tem_cargas`
--

DROP TABLE IF EXISTS `analista_tem_cargas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `analista_tem_cargas` (
  `id_cargas` bigint(20) NOT NULL,
  `id_analista` bigint(20) NOT NULL,
  /* UNIQUE KEY `ANALISTA_UNIQUE_CARGAS` (`id_cargas`,`id_analista`),*/
  KEY `FK_ESPECIALIDADE_MEDICO_ID` (`id_analista`),
  CONSTRAINT `FK_ESPECIALIDADE_MEDICO_ID` FOREIGN KEY (`id_analista`) REFERENCES `analista` (`id`),
  CONSTRAINT `FK_MEDICO_ESPECIALIDADE_ID` FOREIGN KEY (`id_cargas`) REFERENCES `cargas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `analista_tem_cargas`
--

LOCK TABLES `analista_tem_cargas` WRITE;
/*!40000 ALTER TABLE `analista_tem_cargas` DISABLE KEYS */;
/*!40000 ALTER TABLE `analista_tem_cargas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cargas` (
  ...
  `nome_motor` varchar(255) NOT NULL,
